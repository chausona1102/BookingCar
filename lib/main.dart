...
import 'package:booking_app/ui/layout/payment/payment_success.dart';
...
import 'package:booking_app/ui/layout/payment/payment_page.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => BookingAdminManager()),
        ChangeNotifierProvider(create: (_) => StatisticalManager()),
      ],
      child: const AppRoot(),
    );
  }
